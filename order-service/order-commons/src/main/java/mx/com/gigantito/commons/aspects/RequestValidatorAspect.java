package mx.com.gigantito.commons.aspects;

import mx.com.gigantito.commons.exceptions.BusinessException;
...
public class RequestValidatorAspect {
    ...
    @Around(value = "execution(* mx.com.gigantito.web.rest.*.*(..))  && args(..)")
